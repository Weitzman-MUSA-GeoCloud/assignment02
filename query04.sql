...
*/
CREATE INDEX IF NOT EXISTS bus_shapes_shapeid_seq_idx
ON bus_shapes (shape_id,shape_pt_sequence);

CREATE INDEX IF NOT EXISTS bus_trips_shapeid_idx
ON bus_trips (shape_id);

CREATE INDEX IF NOT EXISTS bus_trips_routeid_idx
ON bus_trips (route_id)
